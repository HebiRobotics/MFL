...
* link:./src/test/java/us/hebi/matlab/io/experimental/EjmlSparseWrapper.java[EjmlDMatrixWrapper] serializes link:http://ejml.org[EJML]'s `DMatrix` type
...
* link:./src/test/java/us/hebi/matlab/io/experimental/StreamingDoubleMatrix2D.java[StreamingDoubleMatrix2D] streams incoming row-major data into temporary files and combines them on serialization
