...
* link:./src/test/java/us/hebi/matlab/mat/tests/serialization/ejml/DMatrixWrapper.java[DMatrixWrapper] serializes link:http://ejml.org[EJML]'s `DMatrix` type

* link:./src/test/java/us/hebi/matlab/mat/tests/serialization/ejml/DMatrixSparseCSCWrapper.java[DMatrixSparseCSCWrapper] serializes link:http://ejml.org[EJML]'s `DMatrixSparseCSC` sparse matrix
